...
Write-Host "TrueWebsiteCloner v0.1 - development install" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "PASS: binaries published" -ForegroundColor Green
...
Write-Host "5. In the extension popup, click Test Desktop Connection"
