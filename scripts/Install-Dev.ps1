...
Write-Host "TrueWebsiteCloner v0.6 - development install" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "PASS: Native Host, Desktop, Test Lab, Local Runtime and Offline Tool published" -ForegroundColor Green
